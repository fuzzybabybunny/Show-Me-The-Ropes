...
describe User do
  ...
  describe "presence of a first name" do
    context "first name field not blank" do
      it "is valid with a first name" do
        user = User.new(email: 'harryworld@gmail.com', first_name: 'Harry')
        user.save
        expect(user).to be_valid
        # user = User.find_by email: 'harry@ga.co'
      end
      ...
      it "is invalid without a first name" do
        user = User.new(email: 'harryworld@gmail.com', first_name: nil)
        user.save
  ...
  describe "presence of a last name" do
    context "last name field not blank" do
      it "is valid with a last name" do
        user = User.new(email: 'harryworld@gmail.com', last_name: 'Ng')
        user.save
        expect(user).to be_valid
      end

      it "is invalid without a last name" do
        user = User.new(email: 'harryworld@gmail.com', last_name: nil)
        user.save
        expect(user).to be_invalid
      end
    end
